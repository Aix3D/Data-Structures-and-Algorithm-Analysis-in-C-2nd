...
static Stack_Node * Make_Node (const Name * const panme) ;
...
int Push (Stack * const pstack, const Name * const pname)
{
	Stack_Node * new_node ;
...
int Pop (Stack * const pstack, Name * const pname)
{
	Stack_Node * temp ;
...
static Stack_Node * Make_Node (const Name * const pname)
{
	Stack_Node * new_node ;
